                     ...
                     <div id="subcategory">
                       <div id="realsestate">
                         <div id="realsestatelist">
							...
							?>
							<a id="nounderline" href="<?php echo base_url(),'ad/',$title,'/',$category->category_id,'/',$state_id;?> ">&emsp;&emsp;<?php echo $category->category_name; ?></a><br>
							<?php	
							}
							?>
                         </div>
			...
			<div class="row">
                <div class="container" style="background:#fff8db;padding:0 10px 20px 10px">
                  ...
                  <div class="row">
					...
					?>
					<p style="margin:0;line-height:50%"><a id="nounderline" style="font-size:12px;color:black;" href=" "><?php echo $city->city_name; ?></a></p>
					<?php		
						}
					?> 
                    </div>
                    ...
                    <div class="row">
                     <div class="col-sm-9" style="font-size:15px;">
                       <ul class="breadcrumb" style="margin:0;padding:0 0 0 5px">  
                         ...
                         </li><li class="active"><?php echo $location->state_name;  ?></li>  
                       </ul>
                     </div>
                     <div class="col-sm-3">
