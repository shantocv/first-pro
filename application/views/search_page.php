                 ...
                 <div class="panel-body">
                   <div class="row"> 
                       ...
                       <div class="col-sm-4" style="margin-left:20px;">
                           ...
                           <input type="text" id="min" style="background-color:#f5f5f5;height:32px;width:90px;font-size: 12px;"  class="form-control" placeholder="min" onfocus="this.placeholder = ''" onblur="this.placeholder = 'min'">
                        
                      </div>
                      <div class="col-sm-4 " style="">
                        
                          <input type="text" id="max" style="background-color:#f5f5f5;height:32px;width:90px;font-size: 12px;" class="form-control" placeholder="max" onfocus="this.placeholder = ''" onblur="this.placeholder = 'max'">
                      ...
                      <div class="col-sm-1" >
                          ...
                          <button class="btn btn-default" style="background-color:#e5e5e5;color:white;height:25px;padding:0 5px;margin-left: 4px;margin-top: 4px;" type="button" onclick=minmax(<?php echo $category_id,',','"',$key,'"'; ?>);><i class="glyphicon glyphicon-chevron-right"></i></button>
  ...
  <script>
    $('#any').click(
      function(){
        ...
        var category_name="<?php echo $key;    ?>";
        ...
        located_in= located_in.join("-");
        if(min == "" | max == ""){
          window.location.href=base_url + "filter/" + category_name + "/" + located_in + "/"+ category_id +"/" + 0 + "/" + 0 + "/" + 3 + "/" + seller_type + "/" + sort_by + "/" + 0;
        
      }else{
         window.location.href=base_url + "filter/" + category_name + "/" + located_in + "/"+ category_id +"/" + min + "/" + max + "/" + 3 + "/" + seller_type + "/" + sort_by + "/" + 0;  
      }
