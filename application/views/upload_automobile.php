       ...
       <div class="row" style="width:1024px;padding:0;margin:0 auto;margin-top:20px;" >
         ...
         <div class="col-md-12" id="adlist" style="width:1034px;background:#fafbfd;margin-bottom:20px;">
             <div class="container" style="width:1004px;min-height:730px;padding:0;">
               <div class="row">
                 <div class="col-md-12" style="background:#fafbfd;padding-bottom:10px;padding-left:26px;padding-right:35px;">
                   ...
                   <div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Ad title</span><input type="text"  class="form-control" style="width:220px;display:inline;margin-top:-6px" id="title" style="width:420px;"></p>
                   </div>
				   <div class="row" style="margin:0 0 10px 310px">
                   ...
                   <div class="row" style="margin:0 0 0 80px">
                      ...
                      <div class="col-xs-9" style="width:420px;min-height:90px;background:white;margin:0 0 10px 230px;border:1px solid #ccc;border-radius:5px;margin-top: -30px;">
                        <!-- <div class="row" >
                        ...
                        <form class="ajaxform" method="post" enctype="multipart/form-data" action="<?php  echo base_url(); ?>upload/do_upload">
						  	<input type="hidden" name="do" value="upload"/>
						  	<div class="fileupload" style="margin-top:20px;margin-left:35px;">
					...
					?>
					<div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Brand Name : </span><select class="form-control" style="width:220px;display:inline;margin-top:-10px" name="type" id="type">
				   ...
				   <div id="sub_type" class="row" style="margin:0 0 0 80px"></div>
					
					<div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Body Style : </span><select class="form-control" style="width:220px;display:inline;margin-top:-10px" name="body_style" id="body_style">
				   ...
				   <div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Year : </span><select class="form-control" style="width:220px;display:inline;margin-top:-10px" name="year" id="year">
				   ...
				   <div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">KMs Driven</span><input type="text" class="form-control" style="width:220px;display:inline;margin-top:-6
					  px" id="kilometer" placeholder=" kilometers" style="width:420px;"></p>
                   </div>
				   
				   <div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Color</span><input type="text" class="form-control" style="width:220px;display:inline;margin-top:-6px" id="colour" placeholder=" colour" style="width:420px;"></p>
                   </div>
				   
				   <div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Fuel Type : </span><select class="form-control" style="width:220px;display:inline;margin-top:-10px" name="fuel_type" id="fuel_type">
				   ...
				   <div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Condition : </span><select class="form-control" style="width:220px;display:inline;margin-top:-10px" id="condition" name="condition" >
                   ...
                   <div class="row" style="margin:0 0 0 60px">
                      ...
                      <div style="width:575px;margin:0 0 0 20px;">
                        ...
                        <p style="width:575px;font-size:15px;"> <span style="display:inline-block;width:230px;">State</span>
						<select class="form-control" style="width:220px;display:inline;margin-left:230px;margin-top:-41px" name="state" id="state">
