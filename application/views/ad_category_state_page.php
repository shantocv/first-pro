                     ...
                     <div id="subcategory">
                       <div id="realsestate">
                         ...
                         <div id="realsestatelist" class="panel-collapse collapse">
							...
							?>
							<a id="nounderline" href="<?php echo base_url(),'Ad/',$name,'/',$title,'/',$sub_category->sub_category_id,'/',$state_id;?> ">&emsp;&emsp;&emsp;&emsp;<?php echo $sub_category->sub_category_name; ?></a><br>
							<?php	
							}
							?>
                         </div>
          ...
          <div class="jumbotron" id="adlisttop" style="width:750px;padding:0">
			...
			<div class="row">
                <div class="container" style="background:#fff8db;padding:0 10px 20px 10px">
                  <div class="row">
                    <p style="font-size:15px;font-weight:bold;color:blue;margin: 10px 0 10px 15px">Select Your City</p>
                  </div>
                  <div class="row">
					...
					?>
					<p style="margin:0;line-height:50%"><a id="nounderline" style="font-size:12px;color:black;" href="<?php echo base_url(),'ads/',$name,'/',$category_id,'/',$city->city_id ?> "><?php echo $city->city_name; ?></a></p>
					<?php		
						}
					?>  
              ...
              <div class="row">
                <!--div class="col-sm-6"-->  
                  <ul class="breadcrumb" style="font-size:15px;margin-bottom:5px;">  
                    <li>  
                     <a href="<?php echo base_url(),'categories/',$name,'/',$category_id;?>">India</a> 
                    </li>
					<li>  
              ...
              <div class="row">
                <div class="col-sm-12" style="m">
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="pull-left"><p><strong><?php echo $category_name->category_name;  ?></strong></p></div>
                    </div>
                    <div class="col-sm-6" >
