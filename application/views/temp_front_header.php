<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
  ...
  <html class="no-js"> <!--<![endif]-->
    ...
    <body id="wrapper">
      <div class="navbar  navbar-fixed-top" id="nav" style="height:140px;">
        <div class="container "style="width:100%;margin:0 auto;height:45px;">
			      ...
			      <div class="col-xs-6">
			        <div class="row">
			          <div class="container pull-left"  style="width:280px;margin:10px 0 0 0;">
				       <a href="<?php echo base_url(); ?>">   <img style="width:180px;height:50px" src="<?php echo base_url();?>front_style/img/logo.png"></a>
		        ...
		        <div class="col-xs-6">
			        <div class="row">
			          <div class="container pull-right"  style="width:280px;margin:30px 0 0 0;">
				          <div class="popover-markup pull-right" style="padding:0;">
				            <?php
						  	if($this->session->userdata('logged_in')){
						  ?>
						  <a href="javascript:void(0);" style="font-size:15;"><span style="font-size:15;">Hello <?php echo $this->session->userdata('username');  ?> | </span></a><a href="<?php echo base_url(),'account'; ?>" style="font-size:15;"><span style="font-size:15;">My Yuplee | </span></a></a><a href="<?php echo base_url(),'login_page/logout' ?>" style="color:white;font-size:15;"><span style="color:#166fa7;font-size:15;">logout</span></a>								
						  <?php
							}else{
						  ?>
						  <a href="javascript:void(0);" class="trigger1" style="font-size:15;"><span style="font-size:15;">Sign In | </span></a> <a href="javascript:void(0);" class="trigger2" style="font-size:15;"><span style="font-size:15;">Register</span></a> 
      				      <img id="facebook"  style="cursor:pointer;width:125px;height:25px;margin:0 0 0 10px;padding:0" src=<?php echo base_url();?>front_style/img/fblogin.png> 
						  ...
						  ?>
		        	  	  ...
		        	  	  <div class="content hide">
				              <div class="form-group">
				        	      <p>Email</p><input id="email" type="text" class="form-control" placeholder="Email">
								  <p style="color: red;" id="email_error"></p>
				        		  <p>Password</p><input type="password" id="password" class="form-control" placeholder="Password">
				...
				if(msg == 0){
					...
					window.location.href=base_url + 'account';
		            		...
		            		<div class="regcont hide">
				              <div class="form-group">
				        		    <p>Username</p><input type="text" id="username" class="form-control" placeholder="Username">
							  <p style="color: red;" id="username_error"></p>
				        		    <p>Email</p><input type="text" id="email" class="form-control" placeholder="Email">
									<p style="color: red;" id="reg_email_error"></p>
				        		    <p>Password</p><input type="password" id="password" class="form-control" placeholder="Password">
									<p style="color: red;" id="reg_password_error"></p>
       	        		    <p> Confirm password</p><input type="password" id="conf_password" class="form-control" placeholder="Confirm Password">
								...
								$.ajax({
									...
									success: function(msg)
									{
										if(msg == 0){
											...
											window.location.href=base_url + 'verify_email';
										}
									}
								});
							}
