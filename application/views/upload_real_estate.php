             ...
             <div class="container" style="width:1004px;min-height:730px;padding:0;">
               <div class="row">
                 <div class="col-md-12" style="background:#fafbfd;padding-bottom:10px;padding-left:26px;padding-right:35px;">
				   ...
				   <div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Furnished:</span><select class="form-control" style="width:220px;display:inline;margin-top:-10px"  name="furnished" id="furnished">
				   ...
				   <div class="row" style="margin:0 0 30px 310px">
					  		...
					  		<div id="furnished_error" style="color:red;">
			
							</div>
                   </div>

                   <div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Bedrooms:</span><select class="form-control" style="width:220px;display:inline;margin-top:-10px"  name="bedrooms" id="bedrooms">
				   ...
				   <div class="row" style="margin:0 0 30px 310px">
					  		...
					  		<div id="bedrooms_error" style="color:red;">
			
							</div>
                   </div>

                   <div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Bathrooms:</span><select class="form-control" style="width:220px;display:inline;margin-top:-10px"  name="bathrooms" id="bathrooms">
				   ...
				   <div class="row" style="margin:0 0 30px 310px">
					  		...
					  		<div id="bathrooms_error" style="color:red;">
			
							</div>
                   </div>	

                   <div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Pets:</span><select class="form-control" style="width:220px;display:inline;margin-top:-10px"  name="pets" id="pets">
						<option value=" ">Select</option>
						<option value="yes">Yes</option>
						<option value="no">No</option>
					</select></p>
				   ...
				   <div class="row" style="margin:0 0 30px 310px">
					  		...
					  		<div id="pets_error" style="color:red;">
			
							</div>
                   </div>	

                   <div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Broker Fee:</span><select class="form-control" style="width:220px;display:inline;margin-top:-10px"  name="broker_fee" id="broker_fee">
						<option value=" ">Select</option>
						<option value="yes">Yes</option>
						<option value="no">No</option>
					</select></p>
				   ...
				   <div class="row" style="margin:0 0 30px 310px">
					  		...
					  		<div id="broker_fee_error" style="color:red;">
			
							</div>
                   </div>

                   <div class="row" style="margin:0 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Square Meters:</span><input type="text" class="form-control" style="width:220px;display:inline;margin-top:-10px" style="padding-left: 2px;" name="square_meters" id="square_meters" onkeypress='validate(event)' placeholder="Square Meters" style="width:230px;"></p>
                   </div>		   
...
<div id="footer" style="height:215px;">
	...
	$('#post').click(
		function(){
			...
			if($('#furnished').val() == " "){
				flag=1;
				$('#furnished_error').html("furnished or not ? *");
				$('body').scrollTop(330);	
			}else{
				$('#furnished_error').html("");
			}

			if($('#bedrooms').val() == " "){
				flag=1;
				$('#bedrooms_error').html("select number of bedrooms *");
				$('body').scrollTop(400);	
			}else{
				$('#bedrooms_error').html("");
			}
			...
			if($('#bathrooms').val() == " "){
				$('body').scrollTop(600);
				flag=1;
				$('#bathrooms_error').html("select number of bathrooms *");	
			}else{
				$('#bathrooms_error').html("");
			}

			if($('#pets').val() == " "){
				flag=1;
				$('#pets_error').html("do you have pets *");
				$('body').scrollTop(600);	
			}else{
				$('#pets_error').html("");
			}
			...
			if($('#broker_fee').val() == " "){
				flag=1;
				$('#broker_fee_error').html("broker fee? *");
				$('body').scrollTop(600);	
			}else{
				$('#broker_fee_error').html("");
			}
			...
			$.ajax({
					...
					success: function(msg)
					{
						if(msg == 0){
							...
							var datas='category_id='+ category_id + '&sub_category_id=' + sub_category_id + '&title=' + title + '&description=' + description + '&price=' + price + '&seller_type=' + seller_type + '&contact_name=' + contact_name + '&contact_email=' + contact_email + '&phone=' + phone + '&state_id=' + state_id + '&city_id=' + city_id + '&expire=' + expire + '&furnished=' + furnished + '&bedrooms=' + bedrooms + '&bathrooms=' + bathrooms +'&pets=' + pets + '&broker_fee=' + broker_fee + '&square_meters=' + square_meters + '&hood_name=' + hood_name;
				$.ajax({
					type: "POST",    
