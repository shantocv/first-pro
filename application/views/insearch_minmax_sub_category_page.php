              ...
              ?>
                    ...
                    <div class="col-sm-5" style="margin: 0;padding: 0;">
                      <div class="left-inner-addon">
                        ...
                        <input id="local_search" style="background-color:#f5f5f5;" type="text" class="form-control" placeholder="Search Within <?php echo $category->sub_category_name;  ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search Within <?php echo $category->sub_category_name;  ?> '  " value="<?php  echo $local_search_key ; ?>">
