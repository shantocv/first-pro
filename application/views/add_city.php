			...
			<div class="row leftmenurow">
				...
				<div class="span8 span8bigger">
					<div class="row leftalign">
						<div class="span8 span8bigger dashboardhead">City</div>
					</div>
					<div class="row leftalign">
					...
					<div class="row leftalign">
						<div class="span8 span8bigger statistics">
							<span class="userrechead">Add City</span>
						</div>
					</div>
					...
					<div class="row leftalign">
						<div class="span8 span8bigger addcompanyform">
							<form class="form-horizontal" action="<?php echo base_url(); ?>cities/add_cities" method="post" >
									<fieldset>
										...
										<div class="control-group">
											<div class="controls">
												<select name="state_name">
													...
													<?php
														foreach($state_names as $raw){
															echo '<option value=',$raw->state_id,'>',$raw->state_name,'</option>';
														}
													?>
												</select>
											</div>
