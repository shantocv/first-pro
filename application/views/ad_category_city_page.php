                     ...
                     <div id="subcategory">
                       <div id="realsestate">
                         ...
                         <div id="realsestatelist" class="panel-collapse collapse">
							...
							?>
							<a id="nounderline" href="<?php echo base_url(),'Ads/',$name,'/',$title,'/',$sub_category->sub_category_id,'/',$city_id;?> ">&emsp;&emsp;&emsp;&emsp;<?php echo $sub_category->sub_category_name; ?></a><br>
							<?php	
							}
							?>
                         </div>
              ...
              <div class="row">
                <!--div class="col-sm-6"-->  
                  <ul class="breadcrumb" style="font-size:15px;margin-bottom:5px;">  
					...
					<li>  
                      <a href="<?php  echo base_url(),'ad/',$name,'/',$category_id,'/',$location->state_id;  ?>"><?php echo $location->state_name;  ?></a>  
                    </li>  
