               ...
               <div class="row">
                 <div class="col-md-12" style="background:#fafbfd;padding-bottom:10px;padding-left:26px;padding-right:35px;">
				   ...
				   <div id="sub_type" class="row" style="margin:20px 0 0 80px">
					...
					<div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Company Name</span><input type="text" class="form-control" style="width:220px;display:inline;margin-top:-10px" name="company_name" id="company_name" style="width:420px;"></p>
                   </div>
					
					<div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Job Type</span><select class="form-control" style="width:220px;display:inline;margin-top:-10px"  name="job_type" id="job_type">
				   ...
				   <div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Experience</span><select class="form-control" style="width:220px;display:inline;margin-top:-10px"  name="exp_from" id="exp_from">
					  <option value=" "></option>
						<?php
							for($i=0;$i<=20;$i++){
						...
						<select class="form-control" style="width:220px;display:inline;margin-top:-10px"  name="exp_to" id="exp_to">
						<option value=" "></option>
						<?php
							for($i=0;$i<=20;$i++){
								echo '<option value=',$i,'>',$i,'</option>';		
				   ...
				   <div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Salary Range</span><input type="text" class="form-control" style="width:220px;display:inline;margin-top:-10px" name="salary_from" id="salary_from" style="width:420px;" placeholder="Salary Per Month"> - <input type="text" class="form-control" style="width:220px;display:inline;margin-top:-10px" name="salary_to" id="salary_to" style="width:420px;" placeholder="Salary Per Month"></p>
                   </div>
				   
				   <div class="row" style="margin:20px 0 0 80px">
                      <p style="width:715px;font-size:15px;"> <span style="display:inline-block;width:230px;">Designation</span><input type="text" class="form-control" style="width:220px;display:inline;margin-top:-10px" name="designation" id="designation" style="width:420px;"></p>
                   </div>
