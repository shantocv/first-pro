<?php
  include('include/front_header_category.php');
...
<div class="container" id="wrapper" style="width:100%;margin:0 auto;margin-top:25px;">    
                  ...
                  <div class="panel-heading" id="panel-category" style="background:#e5e5e5">
                    <h4 class="panel-title">
                      <a class="accordion-toggle" id="nounderline" style="color:black;" data-toggle="collapse" data-parent="#categories" href="#category">
                       Categories<img style="width:20px;height:20px;margin-left:128px" src="<?php echo base_url();?>front_style/img/dr.png">
                     </a>
                    </h4> 
                  </div>
                  <!-- end panel heading -->
                  ...
                  <div class="panel-body">
                    <div class="row"> 
                     <div class="col-sm-4" style="margin-left:20px;">
                       <input type="text"  style="background-color:#f5f5f5;height:32px;width:90px;font-size: 12px;"  class="form-control" placeholder="Min" id="min" onfocus="this.placeholder = ''" onblur="this.placeholder = 'min'">
                      </div>
                      <div class="col-sm-4 " style="">
                        <input type="text" style="background-color:#f5f5f5;height:32px;width:90px;font-size: 12px;" class="form-control" placeholder="Max" id="max" onfocus="this.placeholder = ''" onblur="this.placeholder = 'max'">
                      </div>
                      <div class="col-sm-1" >
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-collapse collapse in" id="listseller">
                  <div class="panel-body" style="margin-left:-4px;">
                     <div class="checkbox">
                       <label>
                         <input type="radio" checked="true"  name="seller_type" id="any" value="any"> Any
                       </label>
                     </div>
                     <div class="checkbox">
                       <label>
            ...
            <div class="panel-group" id="located_in">
              ...
              <div class="panel-collapse collapse in pre-scrollable" id="list_located_in">
                <div class="panel-body" style="margin-left:-4px;">
                   ...
                   <div class="checkbox">
                      <label>
                       <input type="radio" name="located_in" value="<?php echo $hood->hood_name;  ?>"> <?php echo $hood->hood_name;  ?>
                      </label>
                   </div>
                   <?php     
                      }
        ...
        <div class="col-sm-8" id="aalist" style="width:724px;padding:0;margin: 0;">
          <div class="jumbotron" id="aalisttop" style="width:724px;padding:0;">
            ...
            ?>
            <span id="follow">
            <button class="btn btn-lg"  style="background-color:#166fa7;width:84px;height:22px;color:white;font-size:11px;padding:0;margin-left:15px;border-radius:1px" id="follow_button" onclick="follow(<?php echo $category_id,',',$this->session->userdata('user_id'),',','\'',$category_name->category_name,'\''; ?>)"><img style="margin:0;width: 15px;height: 15px;margin-top: -2px;margin-left: -8px;" src="http://uploads.zeromaze.com/uploads/plus.png"><span style="margin: 0;"> Follow</span></button>
            ...
            ?>
            <span id="follow">
            <button class="btn btn-lg"  style="background-color:#166fa7;width:84px;height:22px;color:white;font-size:11px;padding:0;margin-left:15px;border-radius:1px" id="unfollow_button" onclick="unfollow(<?php echo $category_id,',',$this->session->userdata('user_id'),',','\'',$category_name->category_name,'\''; ?>)"><img style="margin:0;width: 15px;height: 15px;margin-top: -2px;margin-left: -8px;" src="http://uploads.zeromaze.com/uploads/minus.png"><span style="margin: 0;"> Unfollow</span></button>
              ...
              ?>
                    ...
                    <div class="col-sm-5" style="margin: 0; padding: 0" >
                      <div class="left-inner-addon">
                        ...
                        <input id="local_search" style="background-color:#f5f5f5;" type="text" class="form-control" placeholder="Search Within <?php echo $category_name->category_name; ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search Within <?php echo $category_name->category_name;  ?> '  ">
  ...
  <script>
    function minmax(category_id,category_name){
      ...
      if(min == "" | max == ""){
        ...
        window.location.href=base_url + "filter/" + category_name + "/" + located_in + "/"+ category_id +"/" + min + "/" + max + "/" + 0 + "/" + seller_type + "/" + sort_by + "/" + 0; 
      }
  ...
  <script>
    $('#any').click(
      function(){
        ...
        var sort_by=$('#sort_by').val();
        if(min == "" | max == ""){
          window.location.href=base_url + "filter/" + category_name + "/" + located_in + "/"+ category_id +"/" + 0 + "/" + 0 + "/" + 0 + "/" + seller_type + "/" + sort_by + "/" + 0;
  ...
  <script>
    $("input[name='located_in']").click(function() {
      ...
      $(window).scroll(function(){
        if ($(window).scrollTop() > 150){
          if ($(window).scrollTop() > ($('#aalistmain').height() - 80)){
            if($('#aalistmain').height() < 150 && $(window).scrollTop() < 200){
              $("#leftside-bar").css({"top": ($(window).scrollTop()) -170 + "px"});
            }else{
