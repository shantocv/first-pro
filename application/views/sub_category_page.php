        ...
        <div class="col-sm-8" id="aalist" style="width:724px;padding:0;margin: 0;">
          <div class="jumbotron" id="aalisttop" style="width:724px;padding:0">
            ...
            <button class="btn btn-lg"  style="background-color:#166fa7;width:84px;height:22px;color:white;font-size:11px;padding:0;margin-left:15px;border-radius:1px" id="follow_button" onclick="follow_sub_category(<?php echo $sub_category_id,',',$this->session->userdata('user_id'),',','\'',$category->sub_category_name,'\''; ?>)"><img style="margin:0;width: 15px;height: 15px;margin-top: -2px;margin-left: -8px;" src="http://uploads.zeromaze.com/uploads/plus.png"><span style="margin: 0;"> Follow</span></button>
              <!--<button id="follow_button" onclick="follow_sub_category(<?php echo $sub_category_id,',',$this->session->userdata('user_id'); ?>)" class="btn btn-small">Follow</button>-->
            </span>
            ...
            <!--<button id="unfollow_button" onclick="unfollow_sub_category(<?php echo $sub_category_id,',',$this->session->userdata('user_id'); ?>)" class="btn btn-small">Unfollow</button>-->
            </span>
            <?php   
            }
            }
              ...
              ?>
                    ...
                    <div class="col-sm-5 " style="margin: 0;padding: 0;" >
                      <div class="left-inner-addon">
                        ...
                        <input style="background-color:#f5f5f5;" id="local_search" type="text" class="form-control" placeholder="Search Within <?php echo $category->sub_category_name;  ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search Within <?php echo $category->sub_category_name;  ?> '  " >
