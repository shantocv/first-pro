<?php
  include('include/front_header_sub_category.php');
...
<div class="container" id="wrapper" style="width:100%;margin:0 auto;margin-top:25px;">
      ...
      <div class="panel-group" id="producttype" >
        ...
        <div class="checkbox">
                     <label>
                       <input type="radio" name="product_type" id="product_type" checked="true" value="any"> Any
                     </label>
                   </div>
           ...
           <div class="checkbox">
           <label>
                       <input type="radio" name="product_type" value="<?php echo $type->type_id;  ?>"> <?php echo $type->type_name;  ?>
                   </label>
           </div>
           <?php
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-5 " style="margin: 0;padding: 0;" >
                      <div class="left-inner-addon">
                        ...
                        <input style="background-color:#f5f5f5;" id="local_search" type="text" class="form-control" placeholder="Search Within <?php echo $category->sub_category_name;  ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search Within <?php echo $category->sub_category_name;  ?> '  " value="<?php  echo $local_search_key ; ?>">
              ...
              ?>" class="img-responsive" alt="Responsive image">
               ...
               <div class="col-sm-9" style="padding-left:0px;">
                        <div class="col-sm-12" style="margin-left:0px;padding-left:0px;padding-right:0px;">
                          ...
                          <div class="col-sm-3" style="font-size:15px;color:#166fa7;padding-right:0px;padding-left:0px;"><div class="pull-right" style="font-family:Arial,Helvetica,sans-serif;">&#8377; <?php echo $ad->price;  ?></div> </div> 
                        </div>
                        ...
                        <div class="col-sm-12" style="margin-left:0px;font-size:12px;color:grey;padding-left:0px;padding-right:0px;">
                          ...
                          <?php
                            ...
                            ?>
                            <div class="col-sm-3 pull-right" style="font-size:12px;margin:0;color:grey;padding-left:0px;padding-right:0px;"><?php echo date('M - j - Y ', strtotime($ad->date));  ?></div>
                            <?php    
                              }
  ...
  <script>
    function minmax(category_id,category_name){
      ...
      if(min == "" | max == ""){
        ...
        window.location.href=base_url + "insearch-filter/" +  category_name + '/' +  local_search_key + "/" + located_in + '/' + category_id + '/' + 1 +"/" + min + "/" + max + "/" + 1 + "/" + seller_type + "/" + sort_by + "/" + product_type; 
      }
    ...
    $('#any').click(
      function(){
        ...
        if(min == "" | max == ""){
          local_search_key= local_search_key.split(" ");
          local_search_key=local_search_key.join("-");
          window.location.href=base_url + "insearch-filter/" +  sub_category_name + '/' +  local_search_key + "/" + located_in + '/' + category_id + '/' + 1 +"/" + 0 + "/" + 0 + "/" + 1 + "/" + seller_type + "/" + sort_by + "/" + product_type;
        
      }else{
        local_search_key= local_search_key.split(" ");
          local_search_key=local_search_key.join("-");
          window.location.href=base_url + "insearch-filter/" +  sub_category_name + '/' +  local_search_key + "/" + located_in + '/' + category_id + '/' + 1 +"/" + min + "/" + max + "/" + 1 + "/" + seller_type + "/" + sort_by + "/" + product_type; 
      }
