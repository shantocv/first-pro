            ...
            <div class="panel-group" id="categories" style="margin-bottom:15px;">
             ...
             <div id="category" class="panel-collapse collapse in" style="background:#fafbfd">
              ...
              foreach($sub_categories as $sub_category){
                 $sub_cat_name=str_replace(' ', '-',$sub_category->sub_category_name);  
              ...
              ?>
              <a id="nounderline" href="<?php echo base_url(),$sub_cat_name;?> ">&emsp;&emsp;&emsp;&emsp;<?php echo $sub_category->sub_category_name; ?></a><br>
              <?php 
              }
              ?>
                         </div>
        ...
        <div class="col-sm-8" id="aalist" style="width:724px;padding:0;margin: 0;">
          <div class="jumbotron" id="aalisttop" style="width:724px;padding:0;">
            <div class="container">
                ...
                <div class="col-sm-12">
                  <div class="row">
                    <div class="col-sm-7" style="margin: 0; padding: 10px;">
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="row">
                  <div class="col-sm-8">
                    <div class="row">
                     <div class="col-sm-9" style="font-size:15px;padding-left: 10px;margin-left: 0;">
