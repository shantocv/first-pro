...
<head>
	...
	if($this->session->userdata('city') == 'yuplee'){
		...
		$seo_keyword = str_replace('{location-name}', 'India' , $seo_keyword);
		$seo_desc =  $category->seo_desc;
		$seo_desc =  str_replace('{location-name}', 'India' , $seo_desc);
		?>
		...
		if($located_in == 'any'){
			if($product_type == 'any'){
				$seo_keyword = $category->seo_keyword;
				$seo_keyword = str_replace('{location-name}', $seo , $seo_keyword);
				$seo_desc =  $category->seo_desc;
				$seo_desc =  str_replace('{location-name}', $seo , $seo_desc);
			}else{
				$seo_keyword = $product_type_details->seo_keyword;
				$seo_keyword = str_replace('{location-name}', $seo , $seo_keyword);
				$seo_desc =  $product_type_details->seo_desc;
				$seo_desc =  str_replace('{location-name}', $seo , $seo_desc);
			}
			...
			if($product_type == 'any'){
				$seo_keyword = $category->seo_keyword;
				$seo_keyword = str_replace('{location-name}', "in " . $located_in . " " . $seo , $seo_keyword);
				$seo_desc =  $category->seo_desc;
				$seo_desc =  str_replace('{location-name}', "in " . $located_in . " " . $seo , $seo_desc);
			}else{
				$seo_keyword = $product_type_details->seo_keyword;
				$seo_keyword = str_replace('{location-name}', "in " . $located_in . " " . $seo , $seo_keyword);
				$seo_desc =  $product_type_details->seo_desc;
