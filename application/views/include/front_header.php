...
<head>
	...
	if($this->session->userdata('city') == 'yuplee'){
		?>
		<meta name="keywords" content="Post Free Ads, Free Ads Posting, Post Ads For Free,Free Classifieds,Indian Classifieds,free ads india" />    
		<meta name="description" content="Find a flat for a rent or Sale within a building. Post Jobs, Buy/Sale/Rent flats, apartments, houses, PG, jobs, IT jobs, BPO jobs, cars, used cars, used bikes, motorcycles,in Your Area Post Free Classfied ads and list your business online." />
		<?php    	
	}else{
		$seo = $this->session->userdata('city');
		$seo = ucfirst($seo);
		?>
		<meta name="keywords" content="Post Free Ads in <?php echo $seo ?>, Free Ads Posting in <?php echo $seo ?>, Post Ads For Free in <?php echo $seo ?>,Free Classifieds in <?php echo $seo ?>,Indian Classifieds,free ads in <?php echo $seo ?>" />    
		<meta name="description" content="Find a flat for a rent or Sale within a building in <?php echo $seo ?>. Post Jobs, Buy/Sale/Rent flats, apartments, houses, PG, jobs, IT jobs, BPO jobs, cars, used cars, used bikes, motorcycles,in <?php echo $seo ?> Post Free Classfied ads and list your business online." />
		<?php
	}
	?>
	...
	<!--<link rel="stylesheet" href="<?php echo base_url();?>front_style/css/main.css">-->
      ...
      <script src="<?php echo base_url();?>front_style/js/jquery.form.js "></script>
	...
	<body id="wrapper" style="padding-top:0px;">
		<div class="navbar" id="nav" style="height:140px;border-bottom:0px;">
					...
					<div class="col-xs-8">
						<div class="row">
							<div class="container pull-left"  style="width:280px;margin:10px 0 0 0;">
								<a href="<?php echo base_url(); ?>">   <img style="width:180px;height:50px;margin-left:-5px;" src="<?php echo base_url();?>front_style/img/logo2.png"></a>
								<p style="font-size:14px;color:#e9732b;padding-left:0px;">List your Business Post Free Ads</p>
							</div>
						</div>
						<div class="row" style="padding-left:15px">
							<div class="btn-group select_city">
								<button type="button" class="btn btn-primary dropdown-toggle drop_city" data-toggle="dropdown">
									<?php
									if($this->session->userdata('city') !== 'yuplee'){
										$name_city = $this->session->userdata('city');
										$name_city = ucfirst($name_city);
										echo "$name_city ";	
									}else{
										echo "Select City ";
									} 
								...
								<ul class="dropdown-menu pre-scrollable" role="menu">
									...
									foreach($cities as $city) {
										$drop_city=str_replace(' ', '-',$city->city_name);  
										$drop_city=preg_replace('/[^A-Za-z0-9\-]/', '', $drop_city);
										$drop_city=preg_replace('/--+/', '-', $drop_city);   
										$drop_city=strtolower($drop_city);
								  			# code...
										?>
										<li><a href="<?php echo 'http://',$drop_city,'.zeromaze.com/',$this->uri->uri_string ;  ?>"><?php echo $city->city_name; ?></a></li>
										<?php		
							...
							<div class="input-group pull-right"style="width:390px;height:34px;">
