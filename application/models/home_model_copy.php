<?php
	...
	function get_category($sub_category_id){
		$this->db->select('category.category_id,category.category_name,sub_category.sub_category_name');
	...
	function get_ads_category_city($category_id,$city_id){
	...
	function get_state_ads($state_id){
		$this->db->select('post.post_id,post.post_title,post.description,post.price,post.date,files.id,files.ext');
		$this->db->from('post');
		$this->db->join('files', 'post.post_id = files.post_id');
		$this->db->where('state_id',$state_id);
	...
	function get_ads_category_state($category_id,$state_id){
		$this->db->select('post.post_id,post.post_title,post.description,post.price,post.date,files.id,files.ext');
		$this->db->from('post');
		$this->db->join('files', 'post.post_id = files.post_id');
		$this->db->where('category_id',$category_id);
	...
	function get_ads_sub_category_city($sub_category_id,$city_id){
		$this->db->select('post.post_id,post.post_title,post.description,post.price,post.date,files.id,files.ext');
		$this->db->from('post');
		$this->db->join('files', 'post.post_id = files.post_id');
		$this->db->where('sub_category_id',$sub_category_id);
	...
	function get_ads_sub_category_state($sub_category_id,$state_id){
		$this->db->select('post.post_id,post.post_title,post.description,post.price,post.date,files.id,files.ext');
		$this->db->from('post');
		$this->db->join('files', 'post.post_id = files.post_id');
		$this->db->where('sub_category_id',$sub_category_id);
	...
	function minmax($min,$max,$category_id,$seller_type,$sort_by,$limit, $start,$located_in,$hood_id){
		if($located_in == 'any'){
			if($min == 0 && $max == 0 && $seller_type == 'any' ){
				$this->db->select('kerala.post_id,kerala.post_title,kerala.description,kerala.price,kerala.date,kerala.expire,files.id,files.ext');
				$this->db->from('kerala');
				$this->db->join('files', 'kerala.post_id = files.post_id');
				$this->db->where('category_id',$category_id);
				$this->db->where('status',1);
	       		$this->db->where('city_id',26);
				$this->db->limit($limit, $start);
				$this->db->group_by('post_title');
				$this->db->group_by('kerala.description');
				if($sort_by == 1){
	...
	function minmax_ads_count($min,$max,$category_id,$seller_type,$sort_by){
		if($min == 0 && $max == 0 && $seller_type == 'any' ){
			$this->db->select('post.post_id,post.post_title,post.description,post.price,post.date,post.expire,files.id,files.ext');
			$this->db->from('post');
			$this->db->join('files', 'post.post_id = files.post_id');
	...
	function get_sub_category_minmax_ads($min,$max,$sub_category_id,$seller_type,$sort_by,$product_type,$limit, $start){
	...
	function get_sub_category_minmax_ads_count($min,$max,$sub_category_id,$seller_type,$sort_by,$product_type){
		if($min == 0 && $max == 0 && $seller_type == 'any' && $product_type == 'any' ){
			$this->db->select('post.post_id,post.post_title,post.description,post.price,post.date,post.expire,files.id,files.ext');
			$this->db->from('post');
			$this->db->join('files', 'post.post_id = files.post_id');
	...
	function minmax_search_ads($min,$max,$category_id,$seller_type,$sort_by,$limit, $start,$key){
		if($min == 0 && $max == 0 && $seller_type == 'any' ){
			$this->db->select('post.post_id,post.post_title,post.description,post.price,post.date,post.expire,files.id,files.ext');
			$this->db->from('post');
			$this->db->join('files', 'post.post_id = files.post_id');
	...
	function minmax_search_ads_count($min,$max,$category_id,$seller_type,$sort_by,$key){
		if($min == 0 && $max == 0 && $seller_type == 'any' ){
	...
	function insearch_filter_category_ads_count($key,$id,$min,$max,$flag,$seller_type,$sort_by){
		if($min == 0 && $max == 0 && $seller_type == 'any' ){
			$this->db->select('post.post_id,post.post_title,post.description,post.price,post.date,post.expire,files.id,files.ext');
			$this->db->from('post');
			$this->db->join('files', 'post.post_id = files.post_id');
	...
	function insearch_filter_category_ads($key,$id,$min,$max,$flag,$seller_type,$sort_by,$limit,$start){
		if($min == 0 && $max == 0 && $seller_type == 'any' ){
			$this->db->select('post.post_id,post.post_title,post.description,post.price,post.date,post.expire,files.id,files.ext');
			$this->db->from('post');
			$this->db->join('files', 'post.post_id = files.post_id');
	...
	function insearch_filter_sub_category_ads_count($key,$id,$min,$max,$flag,$seller_type,$sort_by,$product_type){
		if($min == 0 && $max == 0 && $seller_type == 'any' && $product_type == 'any' ){
			$this->db->select('post.post_id,post.post_title,post.description,post.price,post.date,post.expire,files.id,files.ext');
			$this->db->from('post');
			$this->db->join('files', 'post.post_id = files.post_id');
	...
	function insearch_filter_sub_category_ads($key,$id,$min,$max,$flag,$seller_type,$sort_by,$product_type,$limit,$start){
		if($min == 0 && $max == 0 && $seller_type == 'any' && $product_type == 'any' ){
			$this->db->select('post.post_id,post.post_title,post.description,post.price,post.date,post.expire,files.id,files.ext');
			$this->db->from('post');
			$this->db->join('files', 'post.post_id = files.post_id');
